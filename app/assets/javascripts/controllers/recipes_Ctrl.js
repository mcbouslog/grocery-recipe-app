(function() {
  ...
  angular.module("app").controller("recipesCtrl", function(Groceries, Ingredients, Favorites, $scope, $http, $location, $anchorScroll) {
    ...
    Favorites.all().success(function(data) {
      $scope.favoriteRecipes = data;
    });
